...
def draw_text_middle(text, size, color, surface):
    font = pygame.font.SysFont("path/to/gamer_font.ttf", size, bold=True)
...
def draw_main_menu(size, color, surface):
    font = pygame.font.SysFont("path/to/gamer_font.ttf", size, bold=False)
    font_title = pygame.font.SysFont("path/to/gamer_font.ttf", 2 * size, bold=True)
...
def draw_right_side(shape, surface, score):
    # Preview Next Shape
    font = pygame.font.SysFont("path/to/gamer_font.ttf", 30)
...
def draw_window(surface):
    surface.fill((0, 0, 0))
    font = pygame.font.SysFont("path/to/gamer_font.ttf", 60)
...
def main():
    ...
    while run:
        fall_speed = initial_fall_speed + (Score[0] // speed_increase_threshold) * 0.005
